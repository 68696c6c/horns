...
import * as Surfaces from '.'

const defaultTheme = Surfaces.make(Surfaces.defaultConfig)

describe('Surfaces.make', () => {
  it('should return default values if no input is provided', () => {
    const result = Surfaces.make()
  ...
  describe('border', () => {
    ...
    it('should accept "all" inputs', () => {
      ...
      const result = Surfaces.make({ border: { all: inputBorder } })
  ...
  describe('color', () => {
    it('should use the default value if no value is specified', () => {
      const result = Surfaces.make()
      expect(result.color).toBe(Surfaces.defaultConfig.color)
    })

    it('should accept a value', () => {
      const result = Surfaces.make({ color: Color.BgSecondary })
      expect(result.color).toBe(Color.BgSecondary)
    })
  })
  ...
  describe('cursor', () => {
    it('should use the default value if no value is specified', () => {
      const result = Surfaces.make()
      expect(result.cursor).toBe(Surfaces.defaultConfig.cursor)
    })

    it('should accept a value', () => {
      const result = Surfaces.make({ cursor: Cursor.NoDrop })
  ...
  describe('font', () => {
    it('should use the default value if no value is specified', () => {
      const result = Surfaces.make()
      expect(result.font).toBe(Surfaces.defaultConfig.font)
    })

    it('should accept a value', () => {
      const result = Surfaces.make({ font: Font.Compact })
  ...
  describe('shadow', () => {
    ...
    it('should use the configured shadow type if "shadowed" is true', () => {
      const result = Surfaces.make({ shadowed: true })
      expect(result.shadow).toBe(Surfaces.defaultConfig.shadowType)
    })

    it('should use the "none" shadow type if "shadowed" is false', () => {
      const result = Surfaces.make({ shadowed: false })
