...
import * as Lists from '.'
import * as Item from './item'

const defaultItem = Lists.make(Item.defaultConfig)

describe('Lists.make', () => {
  it('should return default values if no input is provided', () => {
    const result = Lists.make()
  ...
  describe('color', () => {
    it('should use the default value if no value is specified', () => {
      const result = Lists.make()
      expect(result.color).toBe(Lists.defaultConfig.color)
    ...
    it('should use the base value for items', () => {
      const result = Lists.make({ color: Color.Tertiary })
      expect(result.color).toBe(Color.Tertiary)
  ...
  describe('cursor', () => {
    it('should use the default value if no value is specified', () => {
      const result = Lists.make()
      expect(result.cursor).toBe(Lists.defaultConfig.cursor)
    ...
    it('should use the base value for items', () => {
      const result = Lists.make({ cursor: Cursor.NotAllowed })
  ...
  describe('font', () => {
    it('should use the default value if no value is specified', () => {
      const result = Lists.make()
      expect(result.font).toBe(Lists.defaultConfig.font)
    ...
    it('should use the base value for items', () => {
      const result = Lists.make({ font: Font.Legal })
  ...
  describe('shadow', () => {
    ...
    it('should use the configured shadow type if "shadowed" is true', () => {
      const result = Lists.make({ shadowed: true })
      expect(result.shadow).toBe(Lists.defaultConfig.shadowType)
    ...
    it('should use the "none" shadow type if "shadowed" is false', () => {
      const result = Lists.make({ shadowed: false })
    ...
    it('should allow items to override the base value with "true"', () => {
      ...
      expect(result.shadow).toBe(ShadowType.None)
      expect(result.currentItem.shadow).toBe(Lists.defaultConfig.shadowType)
    })
  })
})
