---
name: 'SiteHeader Sticky Content'
menu: Layout
---

import { Playground, Props } from 'docz'

import SiteHeaderStickyContent from './site-header-sticky-content'
...
<LayoutDemo variant="dark">
  <SiteHeader 
    ...
    navItems={(
      <React.Fragment>
        <NavItemSticky variant="light" content={<span>Default</span>} stuckContent={<span>Stuck</span>}/>
        <NavItem href="#">Item 1</NavItem>
        <NavItem href="#">Item 2</NavItem>
        <NavItemMenu content="Nav Item Menu 1" menuVariant="secondary">
          <NavItem href="#">Item One</NavItem>
          <NavItem href="#">Item Two</NavItem>
          <NavItemMenu content="Item Three" menuVariant="primary">
            <NavItem href="#">Sub Item One</NavItem>
            <NavItem href="#">Sub Item Two</NavItem>
            <NavItem href="#">Sub Item Three</NavItem>
          </NavItemMenu>
        </NavItemMenu>
        <NavItemMenu content="Nav Item Menu 2" menuVariant="light">
          <NavItem href="#">Item One</NavItem>
          <NavItem href="#">Item Two</NavItem>
          <NavItemMenu content="Item Three" menuVariant="warning">
            <NavItem href="#">Sub Item One</NavItem>
            <NavItem href="#">Sub Item Two</NavItem>
            <NavItem href="#">Sub Item Three</NavItem>
          </NavItemMenu>
  ...
  >
    <SiteHeaderStickyContent content={<span>Default Content</span>} stuckContent={<span>Stuck Content</span>}/>
  </SiteHeader>
...
<Props of={SiteHeaderStickyContent} />
